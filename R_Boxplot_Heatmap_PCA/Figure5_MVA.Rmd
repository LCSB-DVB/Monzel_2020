...
#pdf("PCA_MitoPheno2D_Staining3D.pdf", useDingbats = FALSE)
...
g <- ggbiplot(pca,  ellipse=TRUE, circle=TRUE, choices=c(1,2), labels.size = 2, varname.size	 = 2,varname.adjust=40,varname.abbrev=F,  groups=mydata$Condition)
...
g <- ggbiplot(pca,  ellipse=TRUE, circle=TRUE, choices=c(1,2), labels.size = 0, varname.size	 = 0,varname.adjust=40,varname.abbrev=F,  groups=mydata$Condition)
